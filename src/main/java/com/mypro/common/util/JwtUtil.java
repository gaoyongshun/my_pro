...
import com.mypro.common.exception.MyBootException;
...
public class JwtUtil {
	 ...
	 * @param request
	 * @return
	 * @throws MyBootException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws MyBootException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (ConvertUtil.isEmpty(username)) {
			throw new MyBootException("未获取到用户");
		}
		return username;
	}
