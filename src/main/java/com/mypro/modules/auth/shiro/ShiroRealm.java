...
import com.mypro.common.util.RedisUtil;
import com.mypro.modules.auth.entity.LoginUser;
...
//		info.addStringPermissions(permissionSet);
	...
	public LoginUser checkUserTokenIsEffect(String token) throws AuthenticationException {
		...
		SysUser sysUser = sysUserService.getUserByName(username, EnumConstant.SYS_USER_STATE_NORMAL);
		if (sysUser == null) {
